  ...
  return (
    <div className="animate-in fade-in duration-500">
      <header className="flex items-center justify-between bg-navy text-white p-4 md:px-6 rounded-xl mb-8 shadow-md min-h-[70px] gap-4">
        ...
        <h1 className="text-xl md:text-2xl font-bold m-0 text-center flex-1">Bitácora de observaciones</h1>
          ...
          <>
            {isMobile && (
              <section aria-labelledby="obs-cards-heading">
                ...
                <button type="button" className="inline-flex items-center justify-center gap-2 w-full bg-emerald-600 hover:bg-emerald-700 text-white border-none p-4 rounded-2xl font-black text-sm uppercase tracking-widest cursor-pointer transition-all disabled:bg-slate-300 disabled:cursor-not-allowed shadow-xl shadow-emerald-200 mt-4 active:scale-[0.97] ring-2 ring-emerald-300 ring-offset-1" onClick={onAdd} disabled={!planId}>
