              ...
              <table className="data-table">
                ...
                <tbody>
                  {data.length > 0 ? (
                    data.map((obs) => (
                      <tr key={obs.id}>
                        <td><input defaultValue={obs.participant} onBlur={(e) => handleActionWithStatus(() => onSave(obs.id!, { participant: e.target.value }))} placeholder="Ej. P1" /></td>
                        ...
                        <td><input type="number" defaultValue={obs.time_seconds} onBlur={(e) => handleActionWithStatus(() => onSave(obs.id!, { time_seconds: parseInt(e.target.value) || 0 }))} placeholder="12" /></td>
                        <td><input type="number" defaultValue={obs.errors} onBlur={(e) => handleActionWithStatus(() => onSave(obs.id!, { errors: parseInt(e.target.value) || 0 }))} placeholder="1" /></td>
                        ...
                        <td><textarea defaultValue={obs.proposal} onBlur={(e) => handleActionWithStatus(() => onSave(obs.id!, { proposal: e.target.value }))} placeholder="Ej. Renombrar el menú a 'Notas'" /></td>
